<template>
  ...
  <form @submit.prevent="submit">
    <div>
      ...
      <div class="mt-2">
        <input v-model="data.name" class="form-input" placeholder="Nombre" type="text" id="name" required  autocomplete="off" />
    ...
    <div class="my-4">
      ...
      <div class="mt-2">
        <input v-model="data.email" class="form-input" placeholder="Correo electrónico" type="email" id="email" required autocomplete="off" />
